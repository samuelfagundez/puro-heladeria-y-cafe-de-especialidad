      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6">
        ...
        <nav className="hidden items-center gap-8 md:flex">
          {NAV.map((item) => (
            <a
              key={item.href}
              href={item.href}
              className="text-sm font-medium text-ink/80 transition hover:text-navy"
            >
              {item.label}
            </a>
          ))}
        ...
        <div className="hidden items-center gap-3 md:flex">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="rounded-full bg-navy px-4 py-2 text-sm font-semibold text-cream transition hover:bg-navy-dark"
          >
            Pedir online
          </a>
        </div>
        ...
        <div className="border-t border-black/5 bg-cream px-4 pb-5 md:hidden">
          ...
          <div className="mt-3 flex flex-col gap-2">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="rounded-full bg-navy px-4 py-2.5 text-center text-sm font-semibold text-cream"
            >
              Pedir online
            </a>
          </div>
